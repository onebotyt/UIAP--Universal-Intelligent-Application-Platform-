...
async function bootstrapAdmin() {
  ...
  try {
    ...
    console.log(
      `Assigned ${permsResult.rows.length} core management permissions to Administrator role.`,
    );
