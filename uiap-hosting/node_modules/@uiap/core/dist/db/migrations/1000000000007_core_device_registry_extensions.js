export async function up(pgm) {
    ...
    pgm.addColumns({ schema: 'core', name: 'device_registry' }, {
        type: { type: 'varchar(255)' },
        enabled: { type: 'boolean', notNull: true, default: true },
        credential_hash: { type: 'varchar(255)' },
    });
    // 2. Add device_events_log for idempotency tracking
    pgm.createTable({ schema: 'core', name: 'device_events_log' }, {
...
//# sourceMappingURL=1000000000007_core_device_registry_extensions.js.map