...
export class BackupManager {
    ...
    static async createBackup() {
        ...
        try {
            ...
            const modules = modulesRes.rows.map((r) => ({ id: r.id, version: r.version }));
            const manifest = {
                formatVersion: '1.0',
                coreVersion: '0.1.0',
    ...
    static async restoreBackup(id) {
        ...
        try {
            ...
            throw new Error(`Database restoration failed! Safety checkpoint preserved. Error: ${err.message}`);
        }
        // Clean up
        try {
            await fs.unlink(tempDumpPath);
        ...
        try {
            ...
            console.error(`Runtime failed to initialize after restore: ${err.message}`);
        }
    }
}
