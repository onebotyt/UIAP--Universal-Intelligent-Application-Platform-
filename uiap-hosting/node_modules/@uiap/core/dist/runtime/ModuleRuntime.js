...
export class ModuleRuntime {
    ...
    eventRecovery = new EventRecovery();
     ...
     */
    async activateModule(moduleId, overrideVersion) {
        ...
        try {
            ...
            const context = ModuleContextBuilder.build(moduleId, activeVersion, moduleManifest, this.eventBus);
...
//# sourceMappingURL=ModuleRuntime.js.map